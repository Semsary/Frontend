...
const BalanceManagement = () => {
  ...
  const handleDeposit = async (couponCode) => {
    if (!verified) {
      setShowMessageModal(true);
      setMessageType('error');
      clearError();
    ...
    const result = await deposit(couponCode);

    if (result !== null) {
      setSuccessMessage(`تم إيداع الكوبون بنجاح!`);
    }
  };
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-4 md:p-8" dir="rtl">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-3xl shadow-xl p-8 text-white relative overflow-hidden">
              ...
              <div className="relative">
                <div className="flex items-center justify-between mb-3">
                  <div className="w-12 h-10 bg-white/20 rounded-2xl flex items-center justify-center mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">
            <DepositCard onDeposit={handleDeposit} loading={loading} verified={verified} />
            <WithdrawCard onWithdraw={handleWithdraw} loading={loading} balance={balance} verified={verified} />
            ...
            {premium && verified && (
              <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-3xl shadow-xl p-8 text-white hover:shadow-2xl transition-all duration-300">
                <div className="text-center mb-8">
                  <div className="w-16 h-16 bg-white/20 rounded-3xl flex items-center justify-center mx-auto mb-4">
                    <CheckCircle className="w-8 h-8 text-white" />
                  </div>
                  <h3 className="text-2xl font-bold mb-2">بريميوم نشط</h3>
                  <p className="text-green-100">تم تفعيل العضوية بنجاح</p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white/15 rounded-2xl p-4 text-center">
                    ...
                    <p className="text-sm text-green-100 mt-2">جميع المزايا متاحة</p>
                  </div>
                </div>
              </div>
            )}
          ...
          <MessageModal
            ...
            type={messageType}
            message={messageType === 'success' ? successMessage : (error || "يجب التحقق من الهوية أولاً للقيام بهذه العملية")}
          />
